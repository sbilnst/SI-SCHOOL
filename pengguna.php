...
<div class="content">
    ...
    <div class="container">
        ...
        <div class="box-body">
            <a href="tambah-pengguna.php" class="text-purple"><i class="fa fa-plus"> </i> Tambah </a>
            ...
            <table class="table" >
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <a href="hapus.php?idpengguna=<?= $p['id'] ?>" onclick="return confirm('Yakin ingin hapus pengguna ini?')"title="Hapus Data" class="text-red"><i class="fa fa-times"></i></a>
                    </td>
