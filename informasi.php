...
<div class="content">
    ...
    <div class="container">
        ...
        <div class="box-body">
            <a href="tambah-informasi.php" class="text-purple"><i class="fa fa-plus"> </i> Tambah </a>
            ...
            <table class="table" >
                ...
                <tbody>
                    ...
                    <td><?= $no++ ?> </td>
                    <td><?= $p['judul'] ?> </td>
                    <td><?= substr($p['keterangan'],0, 200) ?> </td>
                    ...
                    <td>
                        ...
                        <a href="hapus.php?idinformasi=<?= $p['id'] ?>" onclick="return confirm('Yakin ingin hapus pengguna ini?')"title="Hapus Data" class="text-red"><i class="fa fa-times"></i></a>
                    </td>
