                    ...
                    if($_FILES['logo_baru']['name'] != ''){
                      ...
                      //  echo 'user telah berhasil mengganti gambar';
                        ...
                        if(!in_array($formatfile_logo, $allowedtype_logo)){
                            ...
                            echo '<div class="alert">Format file logo sekolah tidak diizinkan</div>';
                            ...
                            echo '<div class="alert">Ukuran File logo sekolah tidak boleh lebih dari 1 MB.</div>';
                     ...
                     if($_FILES['favicon_baru']['name'] != ''){
                          ...
                          if(!in_array($formatfile_favicon, $allowedtype_favicon)){
                              ...
                              echo '<div class="alert">Format file favicon sekolah tidak diizinkan</div>';
                              ...
                              echo '<div class="alert">Ukuran File favicon sekolah tidak boleh lebih dari 1 MB.</div>';
