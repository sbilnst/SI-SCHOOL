...
<div class="content">
    ...
    <div class="box">
        ...
        <div class="form-group">
                <label>Nama</label>
                <input type="text" name="nama" class="input-control" placeholder="Nama Kepala Madrasah" value="<?= $d->nama_kepsek ?>" required>
            </div>

            <div class="form-group">
                <label>Sambutan</label>
                <textarea name="sambutan" class="input-control" placeholder="Sambutan Kepala Madrasah" id="keterangan"><?= $d->sambutan_kepsek ?></textarea>
            </div>
                    ...
                    if($_FILES['foto_baru']['name'] != ''){
                      ...
                      //  echo 'user telah berhasil mengganti gambar';
                        ...
                        if(!in_array($formatfile, $allowedtype)){
                            ...
                            echo '<div class="alert">Format file foto kepala sekolah tidak diizinkan</div>';
                            ...
                            echo '<div class="alert">Ukuran File foto kepala sekolah tidak boleh lebih dari 1 MB.</div>';
